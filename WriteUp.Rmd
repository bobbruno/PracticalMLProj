...
set.seed(12345)
tree = train(classe ~ ., data=trainDS, method = "rpart", trControl = tc)
set.seed(12345)
forest = train(classe ~ ., data=trainDS, method = "rf", trControl = tc)
set.seed(12345)
svm = train(classe ~ ., data=trainDS, method = "svmRadial", trControl = tc)
set.seed(12345)
neural = train(classe ~ ., data=trainDS, method = "nnet", trControl = tc, size=45)
stopCluster(cl)
```
